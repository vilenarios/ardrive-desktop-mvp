...
- [x] **UX finish batch — done:** ~~UX-4 listener redesign~~ · ~~UX-5 real profile switching~~ · ~~UX-7~~ · ~~UX-8~~ · ~~UX-10~~ · ~~UX-15 truthful single-drive~~ · ~~UX-18 drive-removal UI~~ · ~~UX-28 global sync indicator~~ · ~~UX-9 in-app confirms~~. *(Also: UX-19/20, SYNC-17/18, UX-33 manifest URL.)* · [ ] **UX-6 auto-login** — a DECISION, not a build (see D-031): recommend **always-prompt for beta** (safer for a self-custody wallet); auto-login is a post-beta opt-in. Pending Phil's confirmation at Gate 6.
